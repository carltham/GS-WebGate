...
1. A full request can travel from submission to result publication over REST.
...
- full_request_to_response_round_trip_over_rest
- retry_on_transient_failure
- timeout_handling_for_stalled_request
