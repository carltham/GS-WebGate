...
- GS-mq acts as the queue and coordination layer between clients and the searcher.
...
6. [components/MQ_ARCHITECTURE.md](components/MQ_ARCHITECTURE.md) — GS-mq internals
